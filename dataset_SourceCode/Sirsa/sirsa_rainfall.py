...
OUTPUT_FILE = "sirsa_daily_avg_rainfall_1979_2024.csv"

# Sirsa bounding box (~29.53°N, 75.03°E)
...
for nc_path in nc_files:
    ...
    if ds_sirsa[rain_var].size == 0:
        print("⚠️ Region slice empty, skipping file.")
        continue

    # --- Convert to DataFrame ---
    df = ds_sirsa[[rain_var]].to_dataframe().reset_index()
...
# === MERGE ALL YEARS ===
if not all_data:
    raise RuntimeError("❌ No valid rainfall data found for Sirsa!")
