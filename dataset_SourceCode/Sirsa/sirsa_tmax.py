...
output_folder = r"C:\Users\tjpri\Downloads\dataset\maxtemp\outputs_tmax_sirsa"
os.makedirs(output_folder, exist_ok=True)

# === Sirsa coordinates ===
target_lat, target_lon = 29.53, 75.03   # Sirsa, Haryana
...
if all_data:
    ...
    out_csv = os.path.join(
        output_folder,
        "Sirsa_Tmax_Daily_1979_2024.csv"
    )

    final.to_csv(out_csv, index=False, float_format="%.2f")
    print(f"\n🎉 Saved Sirsa Tmax (1979–2024) → {out_csv}")
else:
