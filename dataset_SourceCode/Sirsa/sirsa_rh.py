...
# --- Output folder ---
base_folder = os.path.join("era5_rh_1000hpa", "sirsa")
os.makedirs(base_folder, exist_ok=True)

all_daily_files = []

for year in years:
    print(f"\n📅 Downloading ERA5 Relative Humidity for Sirsa – {year}...")

    output_nc_hourly = os.path.join(base_folder, f"sirsa_rh_6hourly_{year}.nc")
    output_nc_daily  = os.path.join(base_folder, f"sirsa_rh_daily_{year}.nc")
    output_csv_daily = os.path.join(base_folder, f"sirsa_rh_daily_{year}.csv")
    ...
    request = {
        ...
        # Sirsa bounding box (N, W, S, E)
        # Center: ~29.53°N, 75.03°E
    ...
    # Clip RH to valid physical range
...
if all_daily_files:
    ...
    merged_csv = os.path.join(base_folder, "sirsa_rh_daily_1979_2024.csv")
