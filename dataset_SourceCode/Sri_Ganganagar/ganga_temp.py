...
input_folder = r"C:\project\dataset\SriGanganagar\maxtemp"     # folder containing GRD files
output_folder = r"C:\project\dataset\SriGanganagar\maxtemp_sri_ganganagar_csv"
os.makedirs(output_folder, exist_ok=True)

# ==============================
# 🌍 SRI GANGANAGAR COORDINATES
# ==============================

CITY = "Sri_Ganganagar"
LAT, LON = 29.92, 73.88   # Sri Ganganagar location
...
def read_grd_file(file_path, year):
    """Reads an IMD GRD file, reshapes, and extracts city Tmax."""
    try:
    ...
    # Extract nearest grid cell to city
...
if all_years:
    ...
    print("\n⚠️ No valid GRD files processed for Sri Ganganagar.")