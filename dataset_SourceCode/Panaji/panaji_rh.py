...
# --- Output folder ---
base_folder = os.path.join("era5_rh_1000hpa", "panaji")
os.makedirs(base_folder, exist_ok=True)

all_daily_files = []

for year in years:
    print(f"\n📅 Downloading ERA5 Relative Humidity for Panaji – {year}...")

    output_nc_hourly = os.path.join(base_folder, f"panaji_rh_6hourly_{year}.nc")
    output_nc_daily  = os.path.join(base_folder, f"panaji_rh_daily_{year}.nc")
    output_csv_daily = os.path.join(base_folder, f"panaji_rh_daily_{year}.csv")
    ...
    request = {
        ...
        # Panaji bounding box (N, W, S, E)
        # Center: 15.49°N, 73.83°E
...
if all_daily_files:
    ...
    merged_csv = os.path.join(base_folder, "panaji_rh_daily_1979_2024.csv")
