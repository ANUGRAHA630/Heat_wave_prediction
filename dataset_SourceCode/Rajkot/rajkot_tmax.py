...
# === Folders ===
input_folder = r"C:\Users\tjpri\Downloads\dataset\maxtemp\tmax_data\maxtemp"   # <-- Change if needed
output_folder = r"C:\Users\tjpri\Downloads\dataset\maxtemp\outputs_tmax_rajkot"
os.makedirs(output_folder, exist_ok=True)

# === Rajkot coordinates ===
target_lat, target_lon = 22.3039, 70.8022   # Rajkot, Gujarat
...
if all_data:
    ...
    out_csv = os.path.join(
        output_folder,
        "Rajkot_Tmax_Daily_1979_2024.csv"
    )

    final.to_csv(out_csv, index=False, float_format="%.2f")
    print(f"\n🎉 Saved Rajkot Tmax (1979–2024) → {out_csv}")
else:
