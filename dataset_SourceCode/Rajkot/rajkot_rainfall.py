...
OUTPUT_FILE = "rajkot_daily_avg_rainfall_1979_2024.csv"

# Rajkot bounding box (~22.30°N, 70.80°E)
LAT_MIN, LAT_MAX = 21.8, 22.8
LON_MIN, LON_MAX = 70.3, 71.3
...
for nc_path in nc_files:
    ...
    if ds_rajkot[rain_var].size == 0:
        print("⚠️ Region slice empty, skipping file.")
        continue

    # --- Convert to DataFrame ---
    df = ds_rajkot[[rain_var]].to_dataframe().reset_index()
...
# === MERGE ALL YEARS ===
if not all_data:
    raise RuntimeError("❌ No valid rainfall data found for Rajkot!")
