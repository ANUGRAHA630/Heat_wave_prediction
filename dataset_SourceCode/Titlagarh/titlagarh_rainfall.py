...
# === Paths ===
input_folder = r"C:\project\dataset\titlagarh_trial2\rainfall"
output_folder = r"C:\project\dataset\titlagarh_trial2\rainfall_titlagarh_csv"
os.makedirs(output_folder, exist_ok=True)

# === Titlagarh Coordinates (°N, °E) ===
LAT, LON = 20.29, 83.15
LAT_BOX, LON_BOX = 0.25, 0.25  # ±0.25° buffer (≈ 25 km area)
...
for file in sorted(os.listdir(input_folder)):
    ...
    try:
        ...
        # --- Save yearly CSV ---
        out_csv = os.path.join(output_folder, f"titlagarh_rainfall_{year}.csv")
...
if all_csvs:
    ...
    merged_csv = os.path.join(output_folder, "titlagarh_rainfall_1979_2024.csv")
    ...
    if os.path.exists(merged_csv):
        try:
            ...
            merged_csv = os.path.join(output_folder, "titlagarh_rainfall_1979_2024_new.csv")
